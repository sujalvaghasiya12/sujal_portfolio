        ...
        <div className="flex justify-between items-center h-16">
          <Link href="/" className="relative group">
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
              className="text-2xl font-bold bg-gradient-to-r from-[#3a7bff] to-[#c7a6ff] bg-clip-text text-transparent"
            >
              Sujal
              <motion.span
          ...
          <div className="hidden md:flex gap-1">
            {navItems.map((item, idx) => (
              ...
              >
                ...
                {activeSection !== item.toLowerCase() && (
                  <motion.div
                    className="absolute bottom-0 left-0 h-0.5 bg-gradient-to-r from-[#3a7bff] to-[#c7a6ff]"
                    initial={{ width: 0, x: 0 }}
